...
impl Time {
    ...
    pub const fn duration_until(self, other: Self) -> Duration {
        ...
        unsafe {
            ...
            hint::assert_unchecked(
                seconds >= (Seconds::MIN.get() as i8) - (Seconds::MAX.get() as i8),
            );
            hint::assert_unchecked(
                seconds <= (Seconds::MAX.get() as i8) - (Seconds::MIN.get() as i8),
            );
            hint::assert_unchecked(
                minutes >= (Minutes::MIN.get() as i8) - (Minutes::MAX.get() as i8),
            );
            hint::assert_unchecked(
                minutes <= (Minutes::MAX.get() as i8) - (Minutes::MIN.get() as i8),
            );
    ...
    pub(crate) const fn adjusting_add(self, duration: Duration) -> (DateAdjustment, Self) {
        ...
        let mut minutes = (self.minute.get() as i8)
...
impl SmartDisplay for Time {
    ...
    fn fmt_with_metadata(
        ...
        let subsecond_width = usize::from(metadata.subsecond_width);
...
impl Sub for Time {
    ...
    fn sub(self, rhs: Self) -> Self::Output {
        ...
        let seconds = i32::from(hour_diff) * Second::per_t::<i32>(Hour)
            + i32::from(minute_diff) * Second::per_t::<i32>(Minute)
            + i32::from(second_diff);
        ...
        unsafe { Duration::new_unchecked(i64::from(seconds), nanoseconds) }
    }
}
